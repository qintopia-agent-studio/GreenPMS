...
### 2026-09-19 已确认扩展：在住跨房型升级会员

用户确认允许客人在原整房继续住宿，同时购买其他整房会员产品，将完整本次住宿计入权益、原企微净收款全部转入会员费。仅本次安排例外，不改变会员产品以后适用房型；实现及后续操作边界以 [在住跨房型升级会员](./spec-cross-room-membership-upgrade.md) 为准。原精确匹配升级及已有会员临时整房建单规则保持有效，新增范围独立待人工验收。

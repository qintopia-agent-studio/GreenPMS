...
- source_spec: 2026-09-12 用户提供的 iPad 投屏房态截图
  ...
  evidence: TypeScript 检查、PR 格式校验器 8 项及 git diff --check 通过；使用真实 Toolbar 组件与项目 CSS 的 Chromium 隔离布局检查，768、820、1024、1194、1280、1366、1440、1920px 各验证筛选收起/展开，滚动吸顶间隙均为 0px。未执行业务 E2E，iPad Safari 实机投屏待反馈。

...
补充：A 最终冻结清单（162文件，SHA256 `ea995750d41e039f2af0cd0661d65700fb7ecf2e0058cdbf9d5f274e19cde35d`）交付后，共享构建/迁移限定回归4/4通过：旧库26条迁移与16张欢迎表保留、新安装、真实签名投递/pull去重消费、重建禁发。共同协议与旧迁移不变；本轮只追加PMS验收脚本和证据，没有改Agent OS。详见联合验收记录末节；v2完整19项和A最终版4项的版本/范围分别保留。

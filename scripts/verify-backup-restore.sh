...
printf 'Backup/restore verified: a populated stage 10 backup upgraded to the complete stage 11 schema with non-empty Order/Stay/revision/inventory/collection/refund/Receipt/audit facts, core invariants, and the sealed 8/32/3 reference catalog intact.\n'
